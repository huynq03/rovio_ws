...
#include "rovio_interfaces/msg/detail/health__rosidl_typesupport_fastrtps_c.h"
...
using _Health__ros_msg_type = rovio_interfaces__msg__Health;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: valid_feature_ratio
  {
    cdr << ros_message->valid_feature_ratio;
  }

  // Field name: tracked_feature_ratio
  {
    cdr << ros_message->tracked_feature_ratio;
  }

  // Field name: pixel_covariance_ratio
  {
    cdr << ros_message->pixel_covariance_ratio;
  }

  // Field name: nis_z_score_rmse
  {
    cdr << ros_message->nis_z_score_rmse;
  }

  // Field name: accel_deviation
  {
  ...
  // Field name: depth_feature_cov_median
  {
...
size_t get_serialized_size_rovio_interfaces__msg__Health(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Health__ros_msg_type * ros_message = static_cast<const _Health__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Health__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rovio_interfaces__msg__Health(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rovio_interfaces
size_t max_serialized_size_rovio_interfaces__msg__Health(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rovio_interfaces__msg__Health;
    is_plain =
      (
...
static size_t _Health__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rovio_interfaces__msg__Health(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rovio_interfaces, msg, Health)() {
