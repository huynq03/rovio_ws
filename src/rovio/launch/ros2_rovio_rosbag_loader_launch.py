...
def generate_launch_description():
    ...
    bag_file_path = os.path.join(package_share, '..', '..', 'datasets', 'machine_hall', 'MH_01_easy', 'MH_01_easy_ros2', 'MH_01_easy_ros2.db3')
    # Ensure default values are strings (launch expects strings for arguments)
